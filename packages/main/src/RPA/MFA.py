    ...
    **Python example usage**
    ...
    def get_oauth_token(
        ...
        :returns: A dictionary containing the access token, metadata and optionally the
            refresh token. (call it with `access_type="offline"` or the set the right
            `scope` in the authorization URL for ensuring the refresh token)
        ...
        **Example: Robot Framework**
        ...
        .. code-block:: robotframework
            ...
            *** Tasks ***
            Finish OAuth Flow
                ${token} =      Get OAuth Token     https://accounts.google.com/o/oauth2/token
    ...
    def refresh_oauth_token(
        ...
        **Example: Robot Framework**
        ...
        .. code-block:: robotframework
            ...
            *** Tasks ***
            Refresh OAuth Flow
                ${token} =      Refresh OAuth Token     https://accounts.google.com/o/oauth2/token
                ...     client_id=810482312368-19htmcgcj*******googleusercontent.com
                ...     client_secret=GOCSPX-******mqZAW89
        ...
        **Example: Python**
        ...
        .. code-block:: python
            ...
            lib_mfa = MFA()
            lib_mfa.refresh_oauth_token("https://accounts.google.com/o/oauth2/token", ...)
        """
