...
class MFA:
    ...
    Passcode is usually long string (16-32 characters), which is usually provided
    with QR code, but it can be usually obtained by requesting access to a string.
