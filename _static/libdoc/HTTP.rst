...
:Create Client Cert Session:
  :Arguments: alias, url, headers={}, cookies={}, client_certs=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'HEAD', 'TRACE', 'PUT', 'DELETE', 'GET']
...
:Create Custom Session:
  :Arguments: alias, url, auth, headers={}, cookies={}, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'HEAD', 'TRACE', 'PUT', 'DELETE', 'GET']
...
:Create Session:
  :Arguments: alias, url, headers={}, cookies={}, auth=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'HEAD', 'TRACE', 'PUT', 'DELETE', 'GET']
